...
use NewPos\Crate\Connection;
use NewPos\Crate\NotImplementedException;
use Mockery as m;
use Illuminate\Database\ConnectionInterface;
use NewPos\Crate\Query\Processors\Processor;
use NewPos\Crate\Query\Grammars\Grammar;
use NewPos\Crate\Query\Builder;
use NewPos\Crate\Connectors\Connector;
...
class QueryTest extends TestCase {
    ...
    {
        $grammar = new Grammar;
        $processor = m::mock('\NewPos\Crate\Query\Processors\Processor');
